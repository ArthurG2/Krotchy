...
def start(message):
    ...
    keyboard2=types.KeyboardButton('Поддержи меня, Кротчи') ##кнопка №2
...
,'У индийского слона беременность длится более 25 месяцев.','Акулы едят ВСЕ. В желудках этих хищников находили обломки лодок, автомобильные покрышки и даже рыцарские латы.']
    if message.text!='Орёл или решка' and  message.text!='Расскажи интересный факт' and  message.text!='Поддержи меня, Кротчи':
    ...
    elif message.text == 'Поддержи меня, Кротчи': ## если написать это, бот тебя поддержит
