...
def knbk(message):
    """
    Функция которая симулирует игру в камень ножницы бумагу с ботом. Эта функция симулирует развитие игры,если игрок выиграл камень путём случайного выбора того, что у бота(К, Н или Б)
